...
import { Library, Mail, Lock, User, Loader2, Sun, Moon } from "lucide-react";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4 relative">
      ...
      <Card className="w-full max-w-md glass animate-in-up">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription>Start managing your library</CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleRegister} className="space-y-3">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="Jane Doe" className="pl-9" value={fullName} onChange={e => setFullName(e.target.value)} required />
              </div>
            </div>
            <div className="space-y-1.5">
